...
@section('content')
    ...
    <div class="container">
        <div class="add-header">
            ...
            <div>
                <h1 class="page-title">Cadastrar Vendedor</h1>
                <p class="page-subtitle">Insira os dados do vendedor</p>
            </div>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label for="user_id">Nome do Vendedor</label>
                            <select name="user_id" id="user_id"
                                    class="form-select @error('user_id') error-input @enderror">
                            ...
                            @error('user_id') <p class="error-message">{{ $message }}</p> @enderror
                        </div>
